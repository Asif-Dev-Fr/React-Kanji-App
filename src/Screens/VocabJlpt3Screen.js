    ...
    vocabulary && (
      <div className="center wrap">
        {vocabulary.map((value) => (
          <div
            className="card cardVocab"
            key={value[0] + "_" + value[1] + "_" + value[2]}
          >
            ...
            <ul className="list-group list-group-flush">
              <li className="list-group-item">
                ...
                {furigana === value[1] ? (
                  <div className="furigana">{value[1]}</div>
                ) : (
                  <div className="furigana">Hidden</div>
                )}
              </li>
              <li className="list-group-item">
                <div>
                  ...
                  >
                    {translation === value[2] && duplicateFurigana === value[1]
                      ? "Hide translation"
                      : "Show translation"}
                  </button>
                </div>
                {translation === value[2] && duplicateFurigana === value[1] ? (
                  ...
                  <div className="translation">Hidden</div>
                )}
              </li>
            </ul>
          </div>
